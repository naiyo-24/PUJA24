  ...
  static const List<MetroLine> lines = [
    MetroLine(
      ...
      stations: [
        ...
        MetroStation(name: 'Mahanayak Uttam Kumar (Tollygunge)', lat: 22.4965, lng: 88.3441),
        MetroStation(name: 'Netaji (Kudghat)', lat: 22.4849, lng: 88.3496),
        MetroStation(name: 'Masterda Surya Sen (Bansdroni)', lat: 22.4764, lng: 88.3582),
        MetroStation(name: 'Gitanjali (Naktala)', lat: 22.4682, lng: 88.3712),
        MetroStation(name: 'Kavi Nazrul (Garia Bazar)', lat: 22.4623, lng: 88.3811),
        MetroStation(name: 'Shahid Khudiram (Briji)', lat: 22.4665, lng: 88.3934),
        MetroStation(name: 'Kavi Subhash (New Garia)', isInterchange: true, lat: 22.4729, lng: 88.4048),
      ],
    ),
    MetroLine(
      id: 'green_east',
      ...
      color: Colors.green,
      stations: [
        MetroStation(name: 'Salt Lake Sector V', isInterchange: true, lat: 22.5794, lng: 88.4347),
        ...
        MetroStation(name: 'Sealdah', isInterchange: true, lat: 22.5695, lng: 88.3711),
      ],
    ),
    MetroLine(
      id: 'green_west',
      ...
      stations: [
        ...
        MetroStation(name: 'Mahakaran (BBD Bagh)', lat: 22.5746, lng: 88.3475),
        MetroStation(name: 'Esplanade', isInterchange: true, lat: 22.5623, lng: 88.3512),
      ],
    ),
    MetroLine(
    ...
    MetroLine(
      ...
      stations: [
        MetroStation(name: 'Kavi Subhash (New Garia)', isInterchange: true, lat: 22.4729, lng: 88.4048),
        MetroStation(name: 'Satyajit Ray (SRFTI)', lat: 22.4821, lng: 88.4035),
        MetroStation(name: 'Jyotirindra Nandi (Mukundapur)', lat: 22.4925, lng: 88.4021),
        MetroStation(name: 'Kavi Sukanta (Kalikapur)', lat: 22.5011, lng: 88.4005),
        MetroStation(name: 'Hemanta Mukhopadhyay (Ruby)', lat: 22.5112, lng: 88.3991),
      ],
    ),
  ];
